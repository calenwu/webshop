...
/**
  ...
  */
function createPhotoswipeOverlayButtons() {
	let prevIcon = document.createElement('i');
	prevIcon.classList.add('fal');
	prevIcon.classList.add('fa-chevron-left');
	prevIcon.classList.add('text-2xl');
	prevIcon.classList.add('text-gray-400');
	prevIcon.classList.add('mr-1');
	let prevContainer = document.createElement('div');
	prevContainer.classList.add('flex');
	prevContainer.classList.add('justify-center');
	prevContainer.classList.add('items-center');
	prevContainer.classList.add('w-12');
	prevContainer.classList.add('h-12');
	prevContainer.classList.add('rounded-full');
	prevContainer.classList.add('p-1');
	prevContainer.classList.add('cursor-pointer');
	prevContainer.classList.add('border');
	prevContainer.classList.add('border-gray-200');
	prevContainer.classList.add('shadow-md');
	prevContainer.classList.add('mr-4');
	prevContainer.classList.add('bg-white');
	prevContainer.appendChild(prevIcon);
	prevContainer.onclick = function() {
		document.getElementsByClassName('pswp__button--arrow--prev')[0].click();
	}

	let closeIcon = document.createElement('i');
	closeIcon.classList.add('fal');
	closeIcon.classList.add('fa-times');
	closeIcon.classList.add('text-2xl');
	closeIcon.classList.add('text-gray-400');
	let closeContainer = document.createElement('div');
	closeContainer.classList.add('flex');
	closeContainer.classList.add('justify-center');
	closeContainer.classList.add('items-center');
	closeContainer.classList.add('w-16');
	closeContainer.classList.add('h-16');
	closeContainer.classList.add('rounded-full');
	closeContainer.classList.add('p-1');
	closeContainer.classList.add('cursor-pointer');
	closeContainer.classList.add('border');
	closeContainer.classList.add('border-gray-200');
	closeContainer.classList.add('shadow-md');
	closeContainer.classList.add('bg-white');
	...
	nextIcon.classList.add('fal');
	nextIcon.classList.add('fa-chevron-right');
	nextIcon.classList.add('text-2xl');
	nextIcon.classList.add('text-gray-400');
	nextIcon.classList.add('ml-1');
	let nextContainer = document.createElement('div');
	nextContainer.classList.add('flex');
	nextContainer.classList.add('justify-center');
	nextContainer.classList.add('items-center');
	nextContainer.classList.add('w-12');
	nextContainer.classList.add('h-12');
	nextContainer.classList.add('rounded-full');
	nextContainer.classList.add('p-1');
	nextContainer.classList.add('cursor-pointer');
	nextContainer.classList.add('border');
	nextContainer.classList.add('border-gray-200');
	nextContainer.classList.add('shadow-md');
	nextContainer.classList.add('ml-4');
	nextContainer.classList.add('bg-white');
	nextContainer.appendChild(nextIcon);
	nextContainer.onclick = function() {
		document.getElementsByClassName('pswp__button--arrow--next')[0].click();
	}

	let bigContainer = document.createElement('div');
	bigContainer.setAttribute('id', 'overlayButtons');
	bigContainer.classList.add('absolute');
	bigContainer.classList.add('z-1');
	bigContainer.classList.add('bottom-12');
	bigContainer.classList.add('w-full');
	bigContainer.classList.add('flex');
	bigContainer.classList.add('justify-center');
	bigContainer.classList.add('items-center');
	bigContainer.appendChild(prevContainer);
	bigContainer.appendChild(closeContainer);
	bigContainer.appendChild(nextContainer);
	return bigContainer;
}
...
class PhotoSwipe extends PhotoSwipeBase {
  ...
  _createMainStructure() {
    ...
    this.scrollWrap = createElement('pswp__scroll-wrap', false, this.template);
		this.scrollWrap.appendChild(createPhotoswipeOverlayButtons());
